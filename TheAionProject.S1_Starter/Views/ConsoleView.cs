...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        /// <summary>
        /// get the weapon of choice from the user
        /// </summary>
        /// <returns></returns>
        public Traveler.Weapon GetWeapon()
        {
            Traveler.Weapon weaponOfChoice;
            Enum.TryParse<Traveler.Weapon>(Console.ReadLine(), out weaponOfChoice);
